...
import { NodeBase, LeafNode, GroupNode } from '../form-entry/form-factory/form-node';
...
describe('Encounter Viewer Service:', () => {
    ...
    it('should find the answer label in the form schema', () => {
        ...
        let label = service.findFormAnswerLabel(answerUuid, schema);
        expect(label).toBe('Ampath');
        answerUuid = '0f8b7f4e-1656-46b7-bc93-d1fe4f193f5d';
        label = service.findFormAnswerLabel(answerUuid, schema);
